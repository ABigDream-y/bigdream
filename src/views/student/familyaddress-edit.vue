	...
	<div class="edit-card--file edit-card-page">
        ...
        <el-input v-model="dataForm.userId" placeholder="用户id"></el-input>
				...
				<el-form-item label="家庭住址" prop="address">
					<el-input v-model="dataForm.address" size="large" placeholder="家庭住址"></el-input>
				</el-form-item>
				<el-form-item label="家庭联系电话" prop="mobile">
					<el-input v-model="dataForm.mobile" size="large" placeholder="家庭联系电话"></el-input>
				</el-form-item>
				<el-form-item label="邮政编码" prop="postCode">
					<el-input v-model="dataForm.postCode" size="large" placeholder="邮政编码"></el-input>
				</el-form-item>
				<el-form-item label="电子邮箱" prop="email">
					<el-input v-model="dataForm.email" size="large" placeholder="电子邮箱"></el-input>
				</el-form-item>
				<el-form-item label="联系人" prop="contacts">
					<el-input v-model="dataForm.contacts" size="large" placeholder="联系人"></el-input>
				</el-form-item>
			</el-form>
		</div>
	</div>
