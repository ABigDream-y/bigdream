	...
	<div class="edit-card--file edit-card-page">
        ...
        <el-input v-model="dataForm.userId" placeholder="用户id"></el-input>
				...
				<el-form-item label="年龄" prop="age">
					<el-input-number v-model="dataForm.age" size="large" placeholder="年龄" :min="1"></el-input-number>
				</el-form-item>
				<el-form-item label="关系" prop="relationship">
					<el-input v-model="dataForm.relationship" size="large" placeholder="关系"></el-input>
				</el-form-item>
				<el-form-item label="政治面貌" prop="politicalOutlook">
					<ren-select v-model="dataForm.politicalOutlook" size="large" dict-type="political_outlook"
						placeholder="政治面貌"></ren-select>
				</el-form-item>
				<el-form-item label="工作单位" prop="jobUnit">
					<el-input v-model="dataForm.jobUnit" size="large" placeholder="工作单位"></el-input>
				</el-form-item>
				<el-form-item label="证件号" prop="idCard">
					<el-input v-model="dataForm.idCard" size="large" placeholder="证件号"></el-input>
				</el-form-item>
				<el-form-item label="职业" prop="career">
					<el-input v-model="dataForm.career" size="large" placeholder="职业"></el-input>
				</el-form-item>
				<el-form-item label="工作地址" prop="jobAdress">
					<el-input v-model="dataForm.jobAdress" size="large" placeholder="工作地址"></el-input>
				</el-form-item>
				<el-form-item label="工作单位联系方式" prop="jobMobile">
					<el-input v-model="dataForm.jobMobile" size="large" placeholder="工作单位联系方式"></el-input>
				</el-form-item>
			</el-form>
		</div>
	</div>
