  ...
  <el-dialog v-model="visible" :title="!dataForm.id ? $t('add') : $t('update')" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-form :model="dataForm" :rules="dataRule" ref="dataFormRef" @keyup.enter="dataFormSubmitHandle()" label-width="120px">
      <el-form-item label="异动原因代码" prop="code">
        <el-input v-model="dataForm.code" placeholder="异动原因代码"></el-input>
      </el-form-item>
      <el-form-item label="异动原因名称" prop="name">
        <el-input v-model="dataForm.name" placeholder="异动原因名称"></el-input>
      </el-form-item>
      <el-form-item label="异动类别代码" prop="categoryCode">
        <el-input v-model="dataForm.categoryCode" placeholder="异动类别代码"></el-input>
      </el-form-item>
